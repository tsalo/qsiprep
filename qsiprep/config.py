...
if not any(
    ...
    from qsiprep._warnings import logging
...
class execution(_Config):
    ...
    """Debug mode(s)."""
    qsiprep_dir = None
    """Root of QSIPrep BIDS Derivatives dataset."""
    ...
    the command line) as spatial references for outputs. NOT YET IMPLEMENTED"""
    reports_only = False
...
class workflow(_Config):
    ...
    *QSIPrep* will run brain extraction of the T1w)."""
    spaces = None
